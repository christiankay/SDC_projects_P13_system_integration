...
class TLDetector (object):
    def __init__(self):
        ...
        rospy.logwarn("### Starting Traffic Light Detector Initialization... ###")
        ...
        self.last_wp = -1
        self.state_count = 0
        rospy.logwarn("### Traffic Light Detector Initialization Done. ###")
        rospy.spin()
    ...
    def get_light_state(self, light):
        ...
        if (not self.has_image):
            ...
            rospy.logdebug("No image available")
            return False
    ...
    def process_traffic_lights(self):
        ...
        """
        #rospy.logwarn("### Start processing traffic lights... ###")
        light = None
        ...
        if light and stop_line_position:
           ...
           # if state is None:
           #     state = 99
            #rospy.logwarn("### Traffic Light Detected State %d", state)
            return stop_line_waypoint, state
        #rospy.logwarn("### Done processing traffic lights. ###")
